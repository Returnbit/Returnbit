...
### Download the Blockchain from the ReturnbitNode Project

The Returnbit node project provides multiple and regulaly updated direct-link downloads. Copies of bootstrap.dat can be downloaded directly from servers provided by ReturnbitNode, or be downloaded from a randomly selected server. All copies of boootstrap are updated at the maximum of every six months.

**Copies of Bootstrap from a specific server**

* [http://mango.returnbitnode.org/bootstrap.dat](http://mango.returnbitnode.org/bootstrap.dat)
* [http://apple.returnbitnode.org/bootstrap.dat](http://apple.returnbitnode.org/bootstrap.dat)

**Randomly selected dopy of Bootstrap**

This could be useful for use in scripts.

* [http://bootstrap.returnbitnode.org/bootstrap.dat](http://bootstrap.returnbitnode.org/bootstrap.dat)
	
**Example usage in a (bash) Terminal**

	wget http://bootstrap.returnbitnode.org/bootstrap.dat       //downloads bootstrap into current directory
