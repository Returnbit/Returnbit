...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Returnbit Core returnbit-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  returnbit-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded returnbit transaction") + "\n" +
              "  returnbit-tx [options] -create [commands]   " + _("Create hex-encoded returnbit transaction") + "\n" +
              "\n";
